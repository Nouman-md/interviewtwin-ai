...
export default function CaseInterview() {
  ...
  const handleNextQuestion = async () => {
    ...
    try {
      ...
      console.error(
        'Failed to load next case question:',
        err
      );
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              ...
              Case Study Question {questionIndex + 1} of {MAX_QUESTIONS}
            ...
            {question ? (
              ...
              <div className="card">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Structure your approach, explain your reasoning, and provide a solution..."
              ...
              <div className="card text-center py-16">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-4">
                  ...
                  No more case studies available
          ...
          >
            ...
            <div className="card">
              ...
              <motion.div
                ...
                className="mb-6 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl"
              >
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-medium text-gray-900 dark:text-white">
                        ...
                        {score >= 80
                          ? 'Excellent analysis!'
                          : score >= 60
                          ? 'Good approach with room for improvement'
